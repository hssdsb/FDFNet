...
class Conv(nn.Module):
    """Standard convolution with args(ch_in, ch_out, kernel, stride, padding, groups组卷积组数, dilation膨胀系数, activation激活函数)."""
...
class ConvTranspose_Add(nn.Module):
    """Convolution transpose 2d layer."""
